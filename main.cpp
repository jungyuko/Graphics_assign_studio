...
void display()
{
  ...
  mat_Trans  = kmuvcl::math::translate(-5.0f, 0.0f, 0.0f);
  mat_Scale  = kmuvcl::math::scale(1.5f, 1.5f, 1.5f);
  mat_Model  = mat_Trans * mat_Scale;
  mat_PVM    = mat_Proj * mat_View * mat_Model;
  glUniformMatrix4fv(loc_u_pvm_matrix, 1, false, mat_PVM);
	g_desk.draw(loc_a_vertex);

  mat_Model  = kmuvcl::math::mat4x4f(1.0f);
  mat_Trans  = kmuvcl::math::translate(0.0f, 5.0f, 0.0f);
  mat_Rotate = kmuvcl::math::rotate(3.14f+t, 0.0f, 1.0f, 0.0f);
  mat_Scale  = kmuvcl::math::scale(1.5f, 1.5f, 1.5f);
  ...
  mat_Model  = kmuvcl::math::mat4x4f(1.0f);
  mat_Trans  = kmuvcl::math::translate(0.0f, 0.0f, 5.0f);
  mat_Scale  = kmuvcl::math::scale(1.5f, 1.5f, 1.5f);
  mat_Rotate = kmuvcl::math::rotate(180.0f, 0.0f, 1.0f, 0.0f);
  mat_Model  = mat_Trans * mat_Rotate * mat_Scale;
  mat_PVM    = mat_Proj * mat_View * mat_Model;
  glUniformMatrix4fv(loc_u_pvm_matrix, 1, false, mat_PVM);
  ...
  mat_Model  = kmuvcl::math::mat4x4f(1.0f);
  mat_Trans  = kmuvcl::math::translate(0.0f, 0.0f, -5.0f);
  mat_Scale  = kmuvcl::math::scale(2.0f, 2.0f, 2.0f);
  mat_Model  = mat_Trans * mat_Scale;
  mat_PVM    = mat_Proj * mat_View * mat_Model;
  glUniformMatrix4fv(loc_u_pvm_matrix, 1, false, mat_PVM);
